    ...
    <div class = "card-wrapper">
      <div class = "card">
        ...
        <div class = "product-imgs">
          <div class = "img-display">
            <div class = "img-showcase">
              <img src = "../assets/img/kopi1.png" alt = "Design by sayyid">
              <img src = "../assets/img/kopi2.png" alt = "Design by sayyid">
              <img src = "../assets/img/kopi3.png" alt = "Design by sayyid">
              <img src = "../assets/img/kopi4.png" alt = "Design by sayyid">
            </div>
          </div>
        ...
        <div class = "product-content">
          <h2 class = "product-title">Cafe Kita</h2>
          <a href = "#" class = "product-link">cafe logo</a>
