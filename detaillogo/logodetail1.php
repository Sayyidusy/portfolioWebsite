    ...
    <div class = "card-wrapper">
      <div class = "card">
        ...
        <div class = "product-imgs">
          <div class = "img-display">
            <div class = "img-showcase">
              <img src = "../assets/img/logobubur1.png" alt = "Design by sayyid">
              <img src = "../assets/img/logobubur2.png" alt = "Design by sayyid">
              <img src = "../assets/img/logobubur3.png" alt = "Design by sayyid">
              <img src = "../assets/img/logobubur4.png" alt = "Design by sayyid">
            </div>
          </div>
        ...
        <div class = "product-content">
          ...
          <a href = "#" class = "product-link">restaurant logo</a>
          ...
          <div class = "product-detail">
            ...
            <p>today I tried to redesign the logo of the restaurantt bubur gowes in bandung indonesia</p>
            <p>=========</p>
          ...
          <!-- ======== JUMLAH PEMBELIAN ======== -->
           ...
           <br><br>
            <!-- <button type="submit" name="submit" class="contact__button">Buy Me!</button> -->
