    ...
    <div class = "card-wrapper">
      <div class = "card">
        ...
        <div class = "product-imgs">
          <div class = "img-display">
            <div class = "img-showcase">
              <img src = "../assets/img/telyukopi1.jpg" alt = "Design by sayyid">
              <img src = "../assets/img/telyukopi2.jpg" alt = "Design by sayyid">
              <img src = "../assets/img/telyukopi3.jpg" alt = "Design by sayyid">
              <img src = "../assets/img/telyukopi4.jpg" alt = "Design by sayyid">
            </div>
          </div>
        ...
        <div class = "product-content">
          <h2 class = "product-title">Telyu Coffee</h2>
          <a href = "#" class = "product-link">Logo Competition TelU Coffee</a>
          ...
          <div class = "product-detail">
            ...
            <p>today I designed just to fulfill my portfolio by creating a coffee logo, hope you guys like.</p>
            <p>=========</p>
