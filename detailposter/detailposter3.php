  ...
  <body>
    ...
    <div class = "card-wrapper">
      <div class = "card">
        ...
        <div class = "product-imgs">
          <div class = "img-display">
            <div class = "img-showcase">
              <img src = "../assets/img/adha1.png" alt = "Design by sayyid">
              <img src = "../assets/img/adha2.png" alt = "Design by sayyid">
              <img src = "../assets/img/adha3.png" alt = "Design by sayyid">
              <img src = "../assets/img/adha4.png" alt = "Design by sayyid">
            </div>
          </div>
        ...
        <h2 class = "product-title">Eid Al Adha 1443 H</h2>
          <a href = "#" class = "product-link">Poster Eid Al Adha</a>
