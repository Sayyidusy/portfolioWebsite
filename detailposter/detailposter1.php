    ...
    <div class = "card-wrapper">
      <div class = "card">
        ...
        <div class = "product-imgs">
          <div class = "img-display">
            <div class = "img-showcase">
              <img src = "../assets/img/rmdhn1.png" alt = "Design by sayyid">
              <img src = "../assets/img/rmdhn2.png" alt = "Design by sayyid">
              <img src = "../assets/img/rmdhn3.png" alt = "Design by sayyid">
              <img src = "../assets/img/rmdhn4.png" alt = "Design by sayyid">
            </div>
          </div>
        ...
        <div class = "product-content">
          <h2 class = "product-title">Ramadhan 1443 H</h2>
          <a href = "#" class = "product-link">Poster Ramadhan</a>
          ...
          <div class = "product-detail">
            ...
            <p>last month I have designed a poster for instagram feed on student activities at telkom university namely PRADA, here I design a countdown to ramadan 1443 H, hope you like it.</p>
            <p>=========</p>
