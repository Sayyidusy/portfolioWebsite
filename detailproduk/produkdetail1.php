    ...
    <div class = "card-wrapper">
      <div class = "card">
        ...
        <div class = "product-imgs">
          <div class = "img-display">
            <div class = "img-showcase">
              <img src = "../assets/img/tel-chips.png" alt = "Design by sayyid">
              <img src = "../assets/img/tel-chips.png" alt = "Design by sayyid">
              <img src = "../assets/img/tel-chips.png" alt = "Design by sayyid">
              <img src = "../assets/img/tel-chips.png" alt = "Design by sayyid">
            </div>
        ...
        <div class = "product-content">
          <h2 class = "product-title">Tel-Chips</h2>
          <a href = "#" class = "product-link">potato snack</a>
          ...
          <div class = "product-detail">
            ...
            <p>This is my first product design which is tel chips, for telkom university</p>
            <p>=========</p>
