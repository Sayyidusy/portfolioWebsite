            ...
            <section class="portfolio section" id="portfolio">
                ...
                <div class="portfolio__container bd-grid">
                    <div class="portfolio__img">
                        <img src="../assets/img/1442.png" alt="">

                        <div class="portfolio__link">
                            <a href="../detailposter/detailposter2.php" class="portfolio__link-name">View details</a>
                        </div>
                    </div>
                    <div class="portfolio__img">
                        <img src="../assets/img/1443.png" alt="">

                        <div class="portfolio__link">
                            <a href="../detailposter/detailposter1.php" class="portfolio__link-name">View details</a>
                        </div>
                    </div>
                    <div class="portfolio__img">
                        <img src="../assets/img/adha.png" alt="">

                        <div class="portfolio__link">
                            <a href="../detailposter/detailposter3.php" class="portfolio__link-name">View details</a>
                        </div>
                    </div>
                    <div class="portfolio__img">
                        <img src="../assets/img/sapmud22.png" alt="">

                        <div class="portfolio__link">
                            <a href="../detailposter/detailposter4.php" class="portfolio__link-name">View details</a>
                        </div>
                    </div>
                    <div class="portfolio__img">
