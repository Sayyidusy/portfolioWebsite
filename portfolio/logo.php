            ...
            <section class="portfolio section" id="portfolio">
                ...
                <div class="portfolio__container bd-grid">
                    <div class="portfolio__img">
                        <img src="../assets/img/cafekita.png" alt="">

                        <div class="portfolio__link">
                            <a href="../detaillogo/logodetail2.php" class="portfolio__link-name">View details</a>
                        </div>
                    </div>
                    <div class="portfolio__img">
                        <img src="../assets/img/buburgowes.png" alt="">

                        <div class="portfolio__link">
                            <a href="../detaillogo/logodetail1.php" class="portfolio__link-name">View details</a>
                        </div>
                    </div>
                    <div class="portfolio__img">
                        <img src="../assets/img/telyu kopi.jpg" alt="">

                        <div class="portfolio__link">
                            <a href="../detaillogo/logodetail3.php" class="portfolio__link-name">View details</a>
                        </div>
                    </div>
                    <div class="portfolio__img">
