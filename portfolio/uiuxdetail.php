        ...
        <div class = "product-imgs">
          <div class = "img-display">
            <div class = "img-showcase">
              <img src = "../assets/img/uiux1.png" alt = "Design by sayyid">
              <img src = "../assets/img/shoe_2.jpg" alt = "Design by sayyid">
              <img src = "../assets/img/shoe_3.jpg" alt = "Design by sayyid">
              <img src = "../assets/img/shoe_4.jpg" alt = "Design by sayyid">
            </div>
          </div>
          <div class = "img-select">
            <div class = "img-item">
              <a href = "#" data-id = "1">
                <img src = "../assets/img/uiux1.png" alt = "shoe image">
              </a>
            </div>
            <div class = "img-item">
              <a href = "#" data-id = "2">
                <img src = "../assets/img/shoe_2.jpg" alt = "shoe image">
              </a>
            </div>
            <div class = "img-item">
              <a href = "#" data-id = "3">
                <img src = "../assets/img/shoe_3.jpg" alt = "shoe image">
              </a>
            </div>
            <div class = "img-item">
              <a href = "#" data-id = "4">
                <img src = "../assets/img/shoe_4.jpg" alt = "shoe image">
              </a>
            </div>
          </div>
        </div>
