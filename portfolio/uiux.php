            ...
            <section class="portfolio section" id="portfolio">
                ...
                <div class="portfolio__container bd-grid">
                    <div class="portfolio__img">
                        <img src="../assets/img/uiux1.png" alt="">

                        <div class="portfolio__link">
                            <a href="../detailuiux/uiuxdetail1.php" class="portfolio__link-name">View details</a>
                        </div>
                    </div>
                    <div class="portfolio__img">
                        <img src="../assets/img/uiux2.png" alt="">

                        <div class="portfolio__link">
                            <a href="../detailuiux/uiuxdetail2.php" class="portfolio__link-name">View details</a>
                        </div>
                    </div>
                    <div class="portfolio__img">
                        <img src="../assets/img/uiux3.png" alt="">

                        <div class="portfolio__link">
                            <a href="../detailuiux/uiuxdetail3.php" class="portfolio__link-name">View details</a>
                        </div>
                    </div>
                    <div class="portfolio__img">
                        <img src="../assets/img/uiux4.png" alt="">

                        <div class="portfolio__link">
                            <a href="../detailuiux/uiuxdetail4.php" class="portfolio__link-name">View details</a>
                        </div>
                    </div>
                    <div class="portfolio__img">
                        <img src="../assets/img/uiuxbuburgowes.png" alt="">

                        <div class="portfolio__link">
                            <a href="../detailuiux/uiuxdetail5.php" class="portfolio__link-name">View details</a>
                        </div>
                    </div>
                    <div class="portfolio__img">
                        ...
                        <div class="portfolio__link">
                            <a href="../detailuiux/uiuxdetail6.php" class="portfolio__link-name">View details</a>
                        </div>
                    </div>
                    ...
                    <div class="portfolio__img">
                        ...
                        <div class="portfolio__link">
                            <a href="../detailuiux/uiuxdetail7.php" class="portfolio__link-name">View details</a>
                        </div>
                    </div>
                    ...
                    <div class="portfolio__img">
                        ...
                        <div class="portfolio__link">
                            <a href="../detailuiux/uiuxdetail8.php" class="portfolio__link-name">View details</a>
                        </div>
                    </div>
                    ...
                    <div class="portfolio__img">
                        ...
                        <div class="portfolio__link">
                            <a href="../detailuiux/uiuxdetail9.php" class="portfolio__link-name">View details</a>
                        </div>
                    </div>
                </div>
            </section>
