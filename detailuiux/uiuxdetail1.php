    ...
    <div class = "card-wrapper">
      <div class = "card">
        ...
        <div class = "product-imgs">
          <div class = "img-display">
            <div class = "img-showcase">
              <img src = "../assets/img/robo1.png" alt = "Design by sayyid">
              <img src = "../assets/img/robo2.png" alt = "Design by sayyid">
              <img src = "../assets/img/robo3.png" alt = "Design by sayyid">
              <img src = "../assets/img/robo4.png" alt = "Design by sayyid">
            </div>
          </div>
        ...
        <div class = "product-content">
          <h2 class = "product-title">Robo Shop</h2>
          <a href = "#" class = "product-link">e-commerce applications</a>
          ...
          <div class = "product-detail">
            ...
            <p>Robo shop pages of e-commerce applications designed, then applied to the dimensions of mobile applications so that users can use it from end to end as an online buying and selling application.</p>
            <p>=========</p>
