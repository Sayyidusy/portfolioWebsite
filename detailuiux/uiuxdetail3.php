    ...
    <div class = "card-wrapper">
      <div class = "card">
        ...
        <div class = "product-imgs">
          <div class = "img-display">
            <div class = "img-showcase">
              <img src = "../assets/img/ok1.png" alt = "Design by sayyid">
              <img src = "../assets/img/ok2.png" alt = "Design by sayyid">
              <img src = "../assets/img/ok3.png" alt = "Design by sayyid">
              <img src = "../assets/img/ok4.png" alt = "Design by sayyid">
            </div>
          </div>
        ...
        <div class = "product-content">
          <h2 class = "product-title">OK Food</h2>
          <a href = "#" class = "product-link">Food Delivery applications</a>
          ...
          <div class = "product-price">
            ...
            <p class = "new-price">Price : <span>$3</span></p>
          </div>

          <div class = "product-detail">
            <h2>about this Design : </h2>
            
            <p>This is my new exploration called OK FOOD, OK Food is a food delivery application, which makes it easy for you to order food anywhere and anytime. Hope you guys like it Cheers! ✨</p>
            <p>=========</p>
