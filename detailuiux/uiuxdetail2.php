    ...
    <div class = "card-wrapper">
      <div class = "card">
        ...
        <div class = "product-imgs">
          <div class = "img-display">
            <div class = "img-showcase">
              <img src = "../assets/img/music1.png" alt = "Design by sayyid">
              <img src = "../assets/img/music2.png" alt = "Design by sayyid">
              <img src = "../assets/img/music3.png" alt = "Design by sayyid">
              <img src = "../assets/img/music4.png" alt = "Design by sayyid">
            </div>
          </div>
        ...
        <div class = "product-content">
          <h2 class = "product-title">Robo Music</h2>
          <a href = "#" class = "product-link">music player applications</a>
          ...
          <div class = "product-detail">
            ...
            <p>an application to listen to your favorite music, can be listened to anytime and anywhere and here provides the lyrics of the music.</p>
            <p>=========</p>
