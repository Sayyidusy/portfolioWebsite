    ...
    <body>
        ...
        <header class="header">
            <div class="header__container">
                ...
                <a href="#" class="header__logo">Zenlo</a>
            ...
            <nav class="nav__container">
                <div>
                    ...
                    <a href="#" class="nav__link nav__logo">
                        ...
                        <span class="nav__logo-name">Zenlo</span>
                    </a>
                     <!--========== SIDE BAR ==========-->
                    <div class="nav__list">
                        <div class="nav__items">
                            ...
                            <div class="nav__dropdown">
                                ...
                                <div class="nav__dropdown-collapse">
                                    <div class="nav__dropdown-content">
                                        <a href="#" class="nav__dropdown-item active">Admin</a>
                            ...
                            <a href="kontak.php" class="nav__link">
